...
function putTextToIndicator(){
	...
	for(var key in indicators){
		...
		if ((prefix == "md") || (prefix == "pw")) {
			...
			//alert(pttButton, btest);
			
			if (value == "ON") {
				//alert('on');
				pttButton.value = "Вкл";
				$('#pttButton').removeClass("redBtn");
				$('#pttButton').addClass("greenBtn");
				$('#pttButton').css('color','black');
				btest.value = "Вкл";
				$('#btest').removeClass("menuButtons");
				$('#btest').addClass("redBtn");
				$('#btest').css('color','Black');
			} else if (value == "OFF") {
				//alert('off');
				pttButton.value = "Выкл";
				$('#pttButton').removeClass("greenBtn");
				$('#pttButton').addClass("redBtn");
				$('#pttButton').css('color','black');
				btest.value = "Выкл";
				$('#btest').removeClass("redBtn");
				$('#btest').addClass("menuButtons");
				$('#btest').css('color','Black');
			}else {
				pttButton.value = "Выкл";
				$('#pttButton').removeClass("redBtn");
				$('#pttButton').removeClass("greenBtn");
				$('#pttButton').addClass("menuButtons");
				$('#pttButton').css('color','gray');
				btest.value = "Выкл";
				$('#btest').removeClass("redBtn");
				$('#btest').removeClass("greenBtn");
				$('#btest').addClass("menuButtons");
				$('#btest').css('color','gray');
			} 
		}else if (key == "b220"){
			var pwr220 = document.getElementById('pwr220');
			if (value == "ON") {
				pwr220.value = "Вкл";
				$('#pwr220').removeClass("redBtn");
				$('#pwr220').addClass("greenBtn");
				$('#pwr220').css('color','Black');
			} else if (value == "OFF") {
				pwr220.value = "Выкл";
				$('#pwr220').removeClass("greenBtn");
				$('#pwr220').addClass("redBtn");
				$('#pwr220').css('color','Black');
			}else {
				pwr220.value = "Выкл";
				$('#pwr220').removeClass("redBtn");
				$('#pwr220').removeClass("greenBtn");
				$('#pwr220').addClass("menuButtons");
				$('#pwr220').css('color','gray');
			} 
		}else if (key == "bcountCH"){
			var countCH = document.getElementById('bcountCH');
			if (value == "1000C") {
				countCH.value = "1000C";
				$('#bcountCH').css('color','Black');
			} else if (value == "1000A") {
				countCH.value = "1000A";
				$('#bcountCH').css('color','Black');
			}else {
				countCH.value = "1000C";
				$('#bcountCH').css('color','Gray');
			} 
